...
QT_MOC_LITERAL(3, 29, 7) // "percent"
    ...
    "ProgressBar\0positionChanged\0\0percent"
};
...
void ProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->positionChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ProgressBar::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressBar::positionChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProgressBar::positionChanged(float _t1)
{
